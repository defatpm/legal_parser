...
def demo_batch_processing():
    ...
    sample_results = [
        {
            ...
            'data': {
                ...
                'timeline': [
                    {'date': '2023-01-01', 'type': 'visit', 'description': 'Initial consultation'},
                    {'date': '2023-01-15', 'type': 'followup', 'description': 'Follow-up appointment'}
                ]
            }
        },
        {
            ...
            'data': {
                ...
                'timeline': [
                    {'date': '2023-01-15', 'type': 'visit', 'description': 'Follow-up visit'}
                ]
            }
        },
        {
    ...
    print(f"✅ Successful: {sum(1 for r in sample_results if r['status'] == 'completed')}")
